            ...
            <form id="signupForm">
                ...
                <div class="mb-6">
                    ...
                    <input type="file" id="profile_picture" name="profile_picture"
                           class="w-full border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition duration-200"
                           accept="image/*"/>
                </div>
                ...
                <div class="mb-6 flex items-start">
                    ...
                    <div class="ml-3 text-sm">
                        <label for="terms" class="font-medium text-gray-700">
                            I agree to the <a href="#" class="text-blue-600 hover:underline">Terms of Service</a> and <a
                                    href="#" class="text-blue-600 hover:underline">Privacy Policy</a>
                        </label>
                    </div>
                </div>
...
<script>
    $(document).ready(function () {
        ...
        const $displayNameInput = $('#display_name');
        ...
        $('#signupForm').on('submit', async function (e) {
            ...
            formData.append('display_name', $displayNameInput.val());
            formData.append('terms', $termsCheckbox.is(':checked'));
            ...
            try {
                ...
                if (response.success) {
                    Toastify({
                        text: "Account created successfully! Logging in...",
                        duration: 3000,
                        close: true,
                        gravity: "top",
                        position: "center",
